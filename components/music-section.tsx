                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-border bg-transparent hover:border-neon-cyan hover:text-neon-cyan hover:bg-transparent"
                    >
                    ...
                    <Button
                      ...
                      className="border-border bg-transparent hover:border-neon-pink hover:text-neon-pink hover:bg-transparent"
                    >
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-muted-foreground/50">
            {platforms.map((platform) => (
              <span
                key={platform}
                className="text-sm uppercase tracking-wider hover:text-neon-cyan transition-colors cursor-pointer"
              >
                {platform}
              </span>
            ))}
