      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {!submitted ? (
            <div className="flex gap-3">
              <Input
                ...
                className="bg-secondary/50 border-border focus:border-neon-pink focus:ring-neon-pink/20 text-foreground placeholder:text-muted-foreground"
                required
              />
              <Button 
                type="submit"
            ...
            <div className="bg-neon-cyan/10 border border-neon-cyan/30 rounded-lg p-4">
              <p className="text-neon-cyan font-medium">You&apos;re in! Welcome to the Shattered Colors family.</p>
            </div>
          )}
        </form>
        ...
        <div className="grid sm:grid-cols-2 gap-8 text-center">
          <div>
            ...
            <a href="mailto:booking@shatteredcolors.com" className="text-neon-pink hover:text-neon-pink/80 transition-colors">
              booking@shatteredcolors.com
            </a>
          </div>
          <div>
            <h3 className="font-display text-lg font-bold uppercase tracking-wider mb-2">Press & Media</h3>
            <a href="mailto:press@shatteredcolors.com" className="text-neon-cyan hover:text-neon-cyan/80 transition-colors">
