...
export function TourSection() {
  return (
    <section id="tour" className="relative py-24 lg:py-32 overflow-hidden">
      {/* Background */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-bold uppercase tracking-tight mb-4">
            Tour <span className="text-neon-pink">Dates</span>
          </h2>
        ...
        <div className="text-center mt-12">
          <Button 
            variant="outline"
            size="lg"
            className="border-neon-cyan text-neon-cyan hover:bg-neon-cyan/10 uppercase tracking-wider"
          >
            View All Tour Dates
          </Button>
        </div>
